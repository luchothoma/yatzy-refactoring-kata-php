# Yatzy Refactoring Kata (extracted from: https://github.com/emilybache/Yatzy-Refactoring-Kata )
...
Make sure you have php and composer installed. Then in this directory:
    ...
    # To run unit tests:
    vendor/bin/phpunit test/YatzyTest.php

### IMPORTANT:
Branch master is the starter point !